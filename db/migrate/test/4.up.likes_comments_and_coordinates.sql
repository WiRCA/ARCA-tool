...
-- -----------------------------------------------------
-- Table `wircatest`.`causelikes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wircatest`.`causelikes` (
...
-- -----------------------------------------------------
-- Table `wircatest`.`correctionlikes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wircatest`.`correctionlikes` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `wircatest`.`correctioncomments`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wircatest`.`correctioncomments` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,
  `correctionId` BIGINT(20) UNSIGNED NOT NULL,
  `userId` BIGINT(20) UNSIGNED NOT NULL,
...
ON `wircatest`.`correctioncomments`
FOR EACH ROW
