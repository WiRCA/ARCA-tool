...
-- -----------------------------------------------------
-- Table `arcatooluser`.`user`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `arcatooluser`.`user` (
...
-- -----------------------------------------------------
-- Table `arcatool`.`cause`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `arcatool`.`cause` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `arcatool`.`relation`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `arcatool`.`relation` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `arcatool`.`correction`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `arcatool`.`correction` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `arcatooluser`.`usercases`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `arcatooluser`.`usercases` (
...
-- -----------------------------------------------------
-- Table `arcatooluser`.`invitation`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `arcatooluser`.`invitation` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `arcatooluser`.`invitationCases`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `arcatooluser`.`invitationCases` (
